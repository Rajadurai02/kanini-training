...
namespace TemplateMVCAppliaction.Services
{
    public class EmployeeRepo : IRepo<Employee>
    {
        ...
        public Employee Update(Employee k)
        {
            ...
            try
            {
                employee = _context.Employees.FirstOrDefault(e => e.EmployeeId == k.EmployeeId);
                employee.Name = k.Name;
                employee.Age = k.Age;
                employee.DepartmentNumber = k.DepartmentNumber;
                _context.SaveChanges();
            }
            catch (ArgumentException ae)
            {
